...
export default function registration() {
    const formAuthorization = document.getElementById("form-registration");
    const divAuthorization = document.querySelector(".registration");
    const apiRegistration = (email, password) => __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch("http://localhost:4448/api/user/registration", {
                method: "POST",
                headers: {
    ...
    formAuthorization === null || formAuthorization === void 0 ? void 0 : formAuthorization.addEventListener("submit", (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield apiRegistration(email, password);
